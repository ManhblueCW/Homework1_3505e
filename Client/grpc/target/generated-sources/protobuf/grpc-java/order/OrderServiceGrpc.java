...
public final class OrderServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<order.Order.OrderRequest,
      order.Order.OrderResponse> getCalculateTotalMethod;
  ...
  public static io.grpc.MethodDescriptor<order.Order.OrderRequest,
      order.Order.OrderResponse> getCalculateTotalMethod() {
    io.grpc.MethodDescriptor<order.Order.OrderRequest, order.Order.OrderResponse> getCalculateTotalMethod;
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void calculateTotal(order.Order.OrderRequest request,
  ...
  public static final class OrderServiceStub
    ...
    /**
     */
    public void calculateTotal(order.Order.OrderRequest request,
        io.grpc.stub.StreamObserver<order.Order.OrderResponse> responseObserver) {
  ...
  public static final class OrderServiceBlockingStub
    ...
    /**
     */
    public order.Order.OrderResponse calculateTotal(order.Order.OrderRequest request) {
  ...
  public static final class OrderServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<order.Order.OrderResponse> calculateTotal(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CALCULATE_TOTAL:
          serviceImpl.calculateTotal((order.Order.OrderRequest) request,
              (io.grpc.stub.StreamObserver<order.Order.OrderResponse>) responseObserver);
          break;
        default:
